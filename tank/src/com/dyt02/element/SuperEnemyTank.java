...
//英雄坦克
public class SuperEnemyTank implements Runnable{
	//成员变量
	//坐标位置
	public int x,y;
	//方向
	...
	public int speed=4;
	//创建敌方坦克子弹类
	public CopyOnWriteArrayList<Bullet> setbs = new CopyOnWriteArrayList<Bullet>();
	public Bullet b;
	//判断敌方坦克存活
	public boolean isLive=true;
	//计数器
	int time=0;
	//count记录我方坦克打到敌方坦克的次数(加强版的)
	public int count=0;
	//录入图片
	Image []images = new Image[4];
	//构造方法
	public SuperEnemyTank(int x, int y, int direct) {
		super();
		try {
			for(int i=0;i<4;i++){
				File input = new File("src/image/superenemy"+(i+1)+".jpg");
