...
//英雄坦克
public class PlusEnemyTank implements Runnable{
	//成员变量
	//坐标位置
	public int x,y;
	//方向
	...
	public int speed=3;
	//创建敌方坦克子弹类
	public CopyOnWriteArrayList<Bullet> petbs = new CopyOnWriteArrayList<Bullet>();
	public Bullet b;
	//判断敌方坦克存活
	...
	//构造方法
	public PlusEnemyTank(int x, int y, int direct) {
		super();
		try {
			for(int i=0;i<4;i++){
				File input = new File("src/image/plusenemy"+(i+1)+".jpg");
